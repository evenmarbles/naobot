...
# -*- coding: utf-8 -*-
#
# naobot documentation build configuration file, created by
...
if on_rtd:
    ...
    MOCK_MODULES = ['numpy', 'pygame',
                    ...
                    'sklearn.mixture',
                    'mpl_toolkits', 'mpl_toolkits.mplot3d', '_c45Tree', 'mlpy.libs', 'mlpy.libs.hmmc']
